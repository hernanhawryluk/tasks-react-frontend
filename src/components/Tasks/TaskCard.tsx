...
function TaskCard({ task }: { task: Task }) {
  ...
  return (
    <div className="bg-zinc-800 w-[90%] sm:w-[100%] lg:w-[47%] xl:w-[31%] 2xl:w-[23%] h-[200px] p-[0.5px] rounded-xl bg-gradient-to-r from-indigo-700 via-purple-700 to-pink-700 z-[1]">
